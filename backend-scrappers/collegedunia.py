...
def fetch_collegedunia_data(query: str, max_results: int = 1, max_reviews: int = 200, cycles: int = 12) -> list:
    # 1. Get the URLs
...
if __name__ == "__main__":
    data = fetch_collegedunia_data("BPIT", max_results=1, max_reviews=200, cycles=12)
